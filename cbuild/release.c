...
static u32 w2c_release_is_authorized_0(w2c_release*);
static u32 w2c_release_refine_0(w2c_release*);
static u32 w2c_release_add_0(w2c_release*, u32, u32);

FUNC_TYPE_T(w2c_release_t0) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_release_t1) = "\xa6\x83\x1a\x14\xc3\x06\xed\xb0\xc1\xda\x87\x2f\x07\x53\x23\x00\xfd\x3d\xd0\x1d\x58\xab\xd8\xbf\xcf\x54\xdb\xc5\x02\xc8\x07\x27";
FUNC_TYPE_T(w2c_release_t2) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";

static void init_memories(w2c_release* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 0, 65536, 0);
}

/* export: 'is_authorized' */
u32 w2c_release_is_authorized(w2c_release* instance) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c_release_is_authorized_0(instance);
#if WASM_RT_USE_SEGUE
...
/* export: 'accumulate' */
u32 w2c_release_accumulate(w2c_release* instance) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
...
/* export: 'refine' */
u32 w2c_release_refine(w2c_release* instance) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c_release_refine_0(instance);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
/* export: 'on_transfer' */
u32 w2c_release_on_transfer(w2c_release* instance) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
...
/* export: 'add' */
u32 w2c_release_add(w2c_release* instance, u32 var_p0, u32 var_p1) {
#if WASM_RT_USE_SEGUE
  uintptr_t segue_saved_base = WASM_RT_SEGUE_READ_BASE();
  WASM_RT_SEGUE_WRITE_BASE(instance->w2c_memory.data);
#endif
  u32 ret = w2c_release_add_0(instance, var_p0, var_p1);
#if WASM_RT_USE_SEGUE
  WASM_RT_SEGUE_WRITE_BASE(segue_saved_base);
#endif
  return ret;
...
static void init_instance_import(w2c_release* instance, struct w2c_index* w2c_index_instance) {
  instance->w2c_index_instance = w2c_index_instance;
}

void wasm2c_release_instantiate(w2c_release* instance, struct w2c_index* w2c_index_instance) {
  assert(wasm_rt_is_initialized());
  init_instance_import(instance, w2c_index_instance);
...
void wasm2c_release_free(w2c_release* instance) {
...
u32 w2c_release_is_authorized_0(w2c_release* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 0u;
  FUNC_EPILOGUE;
...
u32 w2c_release_refine_0(w2c_release* instance) {
  u32 var_l0 = 0, var_l1 = 0, var_l2 = 0, var_l3 = 0;
  u64 var_l4 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  u64 var_j0, var_j1;
  var_j0 = w2c_index_gas(instance->w2c_index_instance);
  var_l4 = var_j0;
  var_i0 = 1u;
  var_l1 = var_i0;
  var_i0 = 1u;
...
u32 w2c_release_add_0(w2c_release* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
